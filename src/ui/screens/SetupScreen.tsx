...
export default function SetupScreen({ secretTokenInput, setSecretTokenInput, handleSetup }: SetupScreenProps) {
    return (
        <div className='bg-[#121212] w-full h-full m-0 p-0 rounded-2xl flex flex-col justify-center items-center text-white border border-[#333] shadow-2xl overflow-hidden px-12'>
